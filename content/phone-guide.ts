...
export const phoneGuide: PhoneGuide = {
  ...
  intro: 'תוכנית "אני והטלפון שלי" מיועדת לבתי ספר שרוב התלמידים בהם כבר מחזיקים סמארטפון. התוכנית מלמדת באופן חווייתי על הסיכונים האפשריים ומקנה כלים לשימוש אחראי ובריא במכשיר.',
