...
export function About() {
  return (
    <section className="py-16 md:py-24 bg-primary relative">
      {/* Decorative circles */}
      <div className="absolute top-0 left-0 w-24 h-24 md:w-32 md:h-32 rounded-full border-4 border-[#f5b642] opacity-60 -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 right-0 w-32 h-32 md:w-48 md:h-48 rounded-full bg-[#8fd18f] opacity-70 translate-x-1/3 translate-y-1/3" />
