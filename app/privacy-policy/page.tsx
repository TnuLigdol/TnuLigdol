      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto prose prose-lg dark:prose-invert">
          <section className="mb-8">
            ...
            <p>
              אתר &quot;תנו לגדול על שקט&quot; מכבד את פרטיות המבקרים. מדיניות
              זו מתארת אילו מידע נאסף, כיצד הוא משמש ואפשרויות הבחירה שלכם.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              אנו עשויים לאסוף מידע שהמשתמש מספק בהרשמה או בפניה (דוא&quot;ל,
              שם), וכן נתוני גלישה וטכנולוגיות כגון Cookies למטרות סטטיסטיקה
              ושיפור החוויה באתר.
            </p>
          </section>
